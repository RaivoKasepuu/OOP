...
public class Auto {
    ...
    private LocalDate kuupäev;              // Auto süsteemi lisamise kuupäev
    ...
    private String töödeNimekiri;           // Autoga seotud tööde nimekiri


    // konstruktor Auto lisamiseks
    public Auto(Integer id, LocalDate kuupäev, String vin, String mark, String mudel, String klient, String asukoht, String töödeNimekiri) {
        this.id = id;
